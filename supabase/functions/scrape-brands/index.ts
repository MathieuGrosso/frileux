...
// Strategy:
//   1. For Shopify-based shops, hit /collections/<handle>/products.json — clean
//      JSON, no scraping needed, reliable.
//   2. Otherwise fetch HTML and parse JSON-LD Product entries.
//   3. OG image as last-resort fallback.
// Breakage per source is expected (WAFs, geoblocks) — we log and skip.
